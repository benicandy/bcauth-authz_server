...
func (t *SimpleChaincode) invoke(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	bcumaIssuer := "http://tff-01.ctiport.net:8888/authen" // デモ用 for Interactive Claim Gathering
	//bcumaIssuer := "http://tff-01.ctiport.net:8888/idp" // デモ用 for OpenID Connect
	// claims_redirect_uri を固定
	//bcumaRedirectUser := "https://as.example.com/redirect_claims"
	bcumaRedirectUser := "http://tff-01.ctiport.net:8888/rqp-claims" // デモ用
